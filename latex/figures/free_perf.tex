\begin{figure*}[ht]
    \centering
\pgfplotstableread[col sep=comma,]{data/perf_free_1000000_16-4096.csv}\datatable
...
\caption{Single-sized free performance. All tests were run on 1,000,000 items.}
\label{fig:free_perf}
\end{figure*}