...
def main():
	...
	if(args.t):
		...
		if any("g" in s for s in args.t):
			testcases["Gallatin"] = os.path.join(build_path, str("b_alloc_test") + executable_extension)
		if any("x" in s for s in args.t):
			testcases["XMalloc"] = os.path.join(build_path, str("x_alloc_test") + executable_extension)
		if any("h" in s for s in args.t):
			testcases["Halloc"] = os.path.join(build_path, str("h_alloc_test") + executable_extension)
		if any("s" in s for s in args.t):
			testcases["ScatterAlloc"] = os.path.join(build_path, str("s_alloc_test") + executable_extension)
		...
		if any("f" in s for s in args.t):
			testcases["FDGMalloc"] = os.path.join(build_path, str("f_alloc_test") + executable_extension)
		if any("r" in s for s in args.t):
			# testcases["RegEff-A"] = os.path.join(build_path, str("r_alloc_test_a") + executable_extension)
			testcases["RegEff-AW"] = os.path.join(build_path, str("r_alloc_test_aw") + executable_extension)
			testcases["RegEff-C"] = os.path.join(build_path, str("r_alloc_test_c") + executable_extension)
			testcases["RegEff-CF"] = os.path.join(build_path, str("r_alloc_test_cf") + executable_extension)
			testcases["RegEff-CM"] = os.path.join(build_path, str("r_alloc_test_cm") + executable_extension)
			testcases["RegEff-CFM"] = os.path.join(build_path, str("r_alloc_test_cfm") + executable_extension)
