...
def main():
	...
	"alloc_tests" : [
		["python test_allocation.py -t o+s+c+r+x+b -num 1000000 -range 16-4096 -iter 50 {0} {1} -timeout 120 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), "performance"],
		["python test_mixed_allocation.py -t o+s+c+r+x+b -num 1000000 -range 16-4096 -iter 50 {0} {1} -timeout 120 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), "mixed_performance"],
		["python test_scaling.py -t o+s+c+r+x+b -byterange 16-16 -threadrange 0-20 -iter 50 {0} {1} -timeout 120 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), "scaling"]
	],
	"frag_tests"  : [
		["python test_fragmentation.py -t o+s+c+r+x+b -num 1000000 -range 4-32 -iter 50 {0} {1} -timeout 180 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""],
		["python test_oom.py -t o+s+c+r+x+b -num 100000 -range 512-512 {0} {1} -timeout 180 -allocsize 4".format(runteststr, genresstr), ""]
	],
	"graph_tests" : [
			["python test_graph_init_big.py -t o+s+c+r+x+b -configfile big_config_init.json {0} {1} -timeout 600 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""],
			["python test_graph_update_big.py -t o+s+c+r+x+b -configfile big_config_update.json {0} {1} -timeout 600 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""],
			["python test_graph_update_big.py -t o+s+c+r+x+b -configfile big_config_update_range.json {0} {1} -timeout 600 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""]
		],
	"synth_tests" : [
		...
		["python test_synth_init.py -t o+s+c+r+x+b {0} {1} -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""],
		["python test_synth_workload.py -t o+s+c+r+x+b -threadrange 0-20 -range 16-1024 -iter 50 {0} {1} -timeout 100 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""],
		["python test_synth_workload.py -t o+s+c+r+x+b -threadrange 0-20 -range 16-1024 -iter 5 {0} {1} -testwrite -timeout 100 -allocsize {2} -device {3}".format(runteststr, genresstr, str(args.mem_size), str(args.device)), ""]
	]
	}
